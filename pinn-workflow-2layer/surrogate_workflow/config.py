...
# Output paths (kept under the 2-layer workflow so 2-layer and 3-layer artifacts never collide).
...
# Dataset generation
N_SAMPLES = int(os.getenv("SURROGATE_N_SAMPLES", "800"))
...
HIDDEN_UNITS = int(os.getenv("SURROGATE_HIDDEN_UNITS", "128"))
