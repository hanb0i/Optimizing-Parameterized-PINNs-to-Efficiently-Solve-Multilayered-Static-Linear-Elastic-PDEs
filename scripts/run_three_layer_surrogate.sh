...
python3 "${REPO_ROOT}/pinn-workflow/surrogate_workflow/run_phase1.py" --regenerate "${@}"
python3 "${REPO_ROOT}/pinn-workflow/surrogate_workflow/verify_phase1.py"
python3 "${REPO_ROOT}/scripts/export_three_layer_surrogate_figures.py"
